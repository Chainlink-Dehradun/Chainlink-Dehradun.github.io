          ...
          <div className="gap-8 rows-2 p-4 sm:p-10">
            ...
            <div className="gap-4 columns-2 2xl:text-4xl lg:text-3xl text-xl font-bold mt-[15px] pr-2">
              <div className="flex-row">
                ...
                <p className="2xl:text-4xl lg:text-3xl sm:text-xl teIn Africa andxt-base">in Graphic Era University!</p>
              </div>
              <div className="flex items-start gap-2 ">
                <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base mt-[25px]">Harness the future of tech with us!</p>
              </div>
            </div>
          </div>
        </div>
